...
const fs = require("fs");
//const { where } = require("../models/auteurs.modele");
...
exports.auteur_suppresion = (requete, reponse) => {
    auteurSchema.find()
    ...
    .then(auteur => {
        ...
        .then(
            ...
            .where("nom").ne("anonyme")//ne = not equals pour ne pas supprimer anonyme si l'auteur anonyme est supprimer
            .exec()
